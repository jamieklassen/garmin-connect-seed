...
//! TODO documen tclass
class GarmagotchiInputDelegate extends WatchUi.BehaviorDelegate {
    private var model;
    ...
    //! handles "swipe down" on venu2s
    //!     decrements yoshi's mood
    //! @return true
    ...
    //! handles "swipe up" on venu2s
    //!     increments yoshi's mood
    //! @return true
